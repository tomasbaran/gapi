...
// colors
const Color kPrimaryColor1 = Color.fromARGB(255, 91, 163, 147);
const Color kPrimaryColorLight = Color.fromARGB(18, 91, 163, 147);
const Color kColorRed = Color(0xFFD09999);
const Color kColorGreen = Color(0xFF9DBDBB);
